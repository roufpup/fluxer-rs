...
/// Data returned by the `READY` dispatch event
#[derive(Deserialize)]
...
/// Data for a session used in [`ReadyData`]
#[derive(Deserialize)]
pub struct Session {
    pub afk: bool,
    pub mobile: bool,
...
/// Data for a logged in user used in [`ReadyData`]
#[derive(Deserialize)]
...
/// Data for a rtc region used in [`ReadyData`]
...
/// Data for notes used in [`ReadyData`]
#[derive(Deserialize)]
pub struct Notes {}

/// Data returned by the `SESSIONS_REPLACE` dispatch event
#[derive(Deserialize)]
